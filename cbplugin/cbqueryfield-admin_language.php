<?php
/**
* Community Builder (TM) cbqueryfield English (United Kingdom) language file Administration
* @version $Id:$
...
return	array(
// 7 language strings from file plug_cbqueryfield/xml/views/view.com_comprofiler.editfield.xml
'INPUT_SUBSTITUTION_SUPPORTED_QUERY_5747c1'	=>	'Input substitution supported Query.',
