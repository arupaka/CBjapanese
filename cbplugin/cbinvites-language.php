<?php
/**
* Community Builder (TM) cbinvites English (United Kingdom) language file Frontend
* @version $Id:$
...
'ENABLE_OR_DISABLE_USAGE_OF_CAPTCHA_ON_INVITES_REQU_79c862'	=>	'Enable or disable usage of captcha on invites. Requires latest CB Captcha to be installed and published. Moderators are exempt from this configuration.',
...
'YOU_HAVE_BEEN_INVITED_BY_USERNAME_TO_JOIN_SITENAME_685ef4'	=>	'<p>You have been invited by [username] to join [sitename]!</p><br />',
...
'INVITE_CODE_CODESITENAME_SITEREGISTRATION_REGISTER_cab6dd'	=>	'<br /><p>Invite Code - [code]<br />[sitename] - [site]<br />Registration - [register]<br />[username] - [profile]</p>',
